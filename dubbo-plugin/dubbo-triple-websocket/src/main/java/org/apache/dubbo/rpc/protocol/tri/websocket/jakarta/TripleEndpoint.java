...
import static org.apache.dubbo.rpc.protocol.tri.websocket.WebSocketConstants.TRIPLE_WEBSOCKET_LISTENER; // Common constant, no servlet dependency
...
public class TripleEndpoint extends Endpoint {
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        WebSocketTransportListener webSocketTransportListener = DefaultWebSocketServerTransportListenerFactory.INSTANCE
                .newInstance(
    ...
    public void onClose(Session session, CloseReason closeReason) {
        ...
        WebSocketTransportListener webSocketTransportListener = (WebSocketTransportListener) session.getUserProperties()
                .get(TRIPLE_WEBSOCKET_LISTENER);
